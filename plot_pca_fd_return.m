function [load_vec_array]=plot_pca_fd_return(pcastr, matplt, harm, expand, cycle, colorwrd)
% Modified from plot_pca_fd: this function will return the eigenfunction (scaled accoridng to variance) as well
...
%                green and red.
% Return: load_vec_array, each columne is the scaled eigen function for corresponding PC
...
%  modified by YUE WU at 02142021
...
if length(dimfd) == 2
    ...
    for iharm = harm
        ...
        load_vec_array=[load_vec_array fac.*vecharm];
